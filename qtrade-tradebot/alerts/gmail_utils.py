...
# GmailAlert to handle bot alerts sent with gmail; 
# for personal use only: check google api quick start to learn how to register app and get credentials
class GmailAlert(BaseAlert):
